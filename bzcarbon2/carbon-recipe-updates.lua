...
if util.me.reuse() then
  util.add_product("low-density-structure", {type="item", name="diamond", amount=1, independent_probability = 0.5, ignored_by_stats=1, ignored_by_productivity=1})
  util.add_product("se-low-density-structure-beryllium", {type="item", name="diamond", amount=1, independent_probability = 0.5, ignored_by_stats=1, ignored_by_productivity=1})
...
if not mods["248k-Redux"] then
    util.add_ingredient("kr-empty-dt-fuel", "graphite", 1)
end
